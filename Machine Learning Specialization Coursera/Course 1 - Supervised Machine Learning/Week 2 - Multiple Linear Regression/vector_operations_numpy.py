...
#the following code gives the same output than the previous one:
...
#access a row (m-1), returning 1-D vector.
print(f"a[2].shape:   {a[2].shape}, a[2]   = {a[2]}, type(a[2])   = {type(a[2])}")

#access a column (n-1), returning 1-D vector.
print(f"a[:,1].shape:   {a[:,1].shape}, a[:,1]   = {a[:,1]}, type(a[:,1])   = {type(a[:,1])}")
